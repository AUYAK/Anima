...
| Weight | Numeric input (kg); saving creates a new measurement entry with current timestamp |
...
- [ ] If user taps back in edit mode, dialog appears: "You have unsaved changes. Save or discard?"
...
## Screens
- PetProfileScreen: gains pencil icon in header; profile gains edit mode state
