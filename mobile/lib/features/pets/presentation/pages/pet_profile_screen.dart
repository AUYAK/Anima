          ...
          children: [
            ...
            _InfoCard(
              children: [
                ...
                if (pet.dob != null) _InfoRow(label: 'Date of birth', value: DateFormat('dd.MM.yyyy').format(pet.dob!)),
                if (age != null) _InfoRow(label: 'Age', value: age),
                if (pet.notes != null) _InfoRow(label: 'Additional info', value: pet.notes!),
              ],
            ),
            ...
            _LifecycleButton(
              ...
              onPressed: () => _confirmStatusChange(
                ...
                ref,
                title: 'Are you sure?',
                message: '${pet.name} will be moved out of your active pets. All their history is kept.',
                status: 'passed_away',
              ),
            ),
            const SizedBox(height: 12),
            _LifecycleButton(
              ...
              onPressed: () => _confirmStatusChange(
                ...
                message: 'Remove ${pet.name} from your list? You can still find them in your Inactive pets.',
                status: 'removed',
              ),
            ),
